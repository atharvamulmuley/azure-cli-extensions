...
def get_chart_path(registry_path, kube_config, kube_context, helm_client_location, container_registry_username=None, container_registry_password=None):
...
def helm_install_release(chart_path, subscription_id, kubernetes_distro, kubernetes_infra, resource_group_name, cluster_name,
                         ...
                         enable_custom_locations, custom_locations_oid, helm_client_location, onboarding_timeout="600", container_registry_repository="",
    ...
    if container_registry_repository:
        ...
        cmd_helm_install.extend(["--set", "systemDefaultValues.image.releaseName={}".format("merge/private")])
        if container_registry_username and container_registry_password:
